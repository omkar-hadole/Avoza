    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
      <div className="flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col pt-4 md:pt-10">
          <p className="text-sm font-semibold tracking-widest uppercase text-gray-500 mb-4">{product.category}</p>
          <h1 className="text-3xl md:text-4xl font-playfair font-bold text-black mb-4">{product.name}</h1>
