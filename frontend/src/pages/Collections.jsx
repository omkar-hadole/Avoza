...
const collections = [
  {
    ...
    description: 'Foundational pieces for the minimalist wardrobe and home. Crafted for longevity and everyday elegance.',
    image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?q=80&w=2572&auto=format&fit=crop',
    link: '/products?category=Apparel',
  },
  {
    title: 'Modern Accents',
    description: 'Elevate your space with our curated selection of architectural lighting, ceramics, and soft furnishings.',
    image: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=2664&auto=format&fit=crop',
    link: '/products?category=Home',
  },
  {
    title: 'Travel Core',
    description: 'Leather goods and accessories designed for seamlessly navigating the world in refined style.',
    image: 'https://images.unsplash.com/photo-1491336477066-31156b5e4f35?q=80&w=2670&auto=format&fit=crop',
  ...
  return (
    <div className="w-full bg-white pt-12 md:pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 text-center">
        ...
        >
          Discover our edit of premium categories, thoughtfully organized to help you find precisely what you're looking for.
        </motion.p>
      </div>
          ...
          >
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-12 md:p-24 bg-beige/30">
              <div className="max-w-md text-center md:text-left">
                <span className="text-xs font-semibold tracking-widest uppercase text-gray-400 mb-4 block">Collection {String(index + 1).padStart(2, '0')}</span>
